...
#if defined(__unix__) || defined(__APPLE__)
	char **symbols =
		backtrace_symbols(td->exc_backtrace, td->exc_backtrace_count);
...
var Exception_Throw(var obj, const char *fmt, const char *file,
					const char *func, int lineno, var_list vl)
{
